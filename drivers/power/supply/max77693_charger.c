...
extern struct max77693_muic_info *g_max77693_muic_info;
...
void max77693_reset_chgtyp(struct max77693_charger *chg)
{
	...
	regmap_read(g_max77693_muic_info->max77693->regmap_muic,
			  MAX77693_MUIC_REG_CDETCTRL1,
			  &reg_data);
	regmap_update_bits(g_max77693_muic_info->max77693->regmap_muic,
			  MAX77693_MUIC_REG_CDETCTRL1,
...
static int max77693_get_cable_type(struct max77693_charger *chg, struct regmap *regmap, int *val)
{
	...
	do {
		...
		ret = regmap_read(g_max77693_muic_info->max77693->regmap_muic,
